...
python有个wsgi basic auth的库，使用特别方便。 [github](https://github.com/mvantellingen/wsgi-basic-auth)

### SSL
免费ssl证书可以从[https://letsencrypt.org/](https://letsencrypt.org/)申请，申请推荐使用certbot工具。
...
certbot安装参考[https://certbot.eff.org/lets-encrypt/centosrhel8-nginx](https://certbot.eff.org/lets-encrypt/centosrhel8-nginx)

支持SSL的python wsgi server: [https://f.gallai.re/wsgiserver](https://f.gallai.re/wsgiserver)
